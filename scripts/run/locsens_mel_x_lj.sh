...
# python synthesize.py --variant tacotron_bk2orig --mode synthesis --gta True --base_dir ${dataDir} --output_dir ${ProjectDir}/results/${NAME}/ --training_dir 163-lj-training/ --text_list ${dataDir}/163-lj-training/test.txt --dataset train --hparams "sample_rate=16000,frame_length_ms=20,frame_shift_ms=5,pml_dimension=163,spec_type=fwbnd" --checkpoint ${ProjectDir}results/logs-tacotron-bk2orig/model.ckpt-120000

# python synthesize.py --variant tacotron_bk2orig --mode synthesis --eal True --base_dir ${dataDir} --output_dir ${ProjectDir}/results/${NAME}/ --training_dir 163-lj-training/ --text_list ${dataDir}/163-lj-training/test.txt --dataset train --hparams "sample_rate=16000,frame_length_ms=20,frame_shift_ms=5,pml_dimension=163,spec_type=fwbnd" --checkpoint ${ProjectDir}results/logs-tacotron-bk2orig/model.ckpt-120000

# python synthesize.py --variant tacotron_bk2orig --mode eval --base_dir ${dataDir} --output_dir ${ProjectDir}/results/${NAME}/ --training_dir 163-lj-training/ --text_list ${ProjectDir}/tests/sentences.txt --hparams "sample_rate=16000,frame_length_ms=20,frame_shift_ms=5,pml_dimension=163,spec_type=fwbnd" --checkpoint ${ProjectDir}results/logs-tacotron-bk2orig/model.ckpt-120000



############################ train with eal
python train.py --variant tacotron_bk2orig --base_dir /scratch/je369/tacotron --name tacotron-bk2orig-eal-scratch --log_dir ${ProjectDir}results --num_steps 150000 --tacotron_input 163-lj-training/train.txt --hparams "sample_rate=16000,frame_length_ms=20,frame_shift_ms=5,pml_dimension=163,spec_type=fwbnd" --slack_url ${URL} --eal_dir ${ProjectDir}results/tacotron-bk2orig/gta/alignment/npy/ --restore_step 112000
# ${ProjectDir}results/tacotron-pml-x-163/gta/alignment/npy/
