...
which python
python preprocess.py --base_dir /scratch/je369/tacotron/ --dataset lj
...
cd /home/miproj/4thyr.oct2018/je369/workspace/implementations/tacotron
python train_pml.py --model tacotron_pml --base_dir /scratch/je369/tacotron --name $NAME --log_dir /scratch/je369/results --num_steps 100000
