# 0 preparation
NAME=tacotron-schedsamp-simple-pml-x-163 #////////////////////////////////////TBC
...
cd /home/miproj/4thyr.oct2018/je369/workspace/implementations/tacotron
python train.py --variant tacotron_simpl --base_dir /scratch/je369/tacotron --name $NAME --log_dir /scratch/je369/results --tacotron_input 163-lj-training/train.txt --hparams "sample_rate=16000,frame_length_ms=20,frame_shift_ms=5,pml_dimension=163,spec_type=fwbnd,scheduled_sampling=True" --slack_url https://hooks.slack.com/services/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
