# 0 preparation
NAME=tacotron-lstm-simplified-pml-lj #////////////////////////////////////TBC
...
python remove_training_data.py --train_dir corrected-lj-training
...
which python
python preprocess.py --base_dir /scratch/je369/tacotron/ --dataset ljspeech --output corrected-lj-training --hparams "sample_rate=16000,frame_length_ms=20,frame_shift_ms=5,pml_dimension=163" --validation_size 150 # ljspeech used as dataset key
...
cd /home/miproj/4thyr.oct2018/je369/workspace/implementations/tacotron
python train.py --variant tacotron_lstm_short --base_dir /scratch/je369/tacotron --name $NAME --log_dir /scratch/je369/results --num_steps 150000 --tacotron_input corrected-lj-training/train.txt --hparams "sample_rate=16000,frame_length_ms=20,frame_shift_ms=5,pml_dimension=163" --slack_url https://hooks.slack.com/services/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
