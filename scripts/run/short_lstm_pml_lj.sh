...
cd /home/miproj/4thyr.oct2018/je369/workspace/implementations/tacotron
python train.py --variant tacotron_lstm_short --base_dir /scratch/je369/tacotron --name $NAME --log_dir /scratch/je369/results --num_steps 150000 --tacotron_input corrected-lj-training/train.txt --hparams "sample_rate=22050,frame_length_ms=20,frame_shift_ms=5,pml_dimension=163" --slack_url https://hooks.slack.com/services/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
